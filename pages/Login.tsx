...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simple redirect based on email for demo purposes (usually handled by role in auth context)
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
             Use <span className="font-bold">admin@medihub.africa</span> / <span className="font-bold">admin123</span> for Admin Access
          </p>
        </div>
